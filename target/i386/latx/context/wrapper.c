...
#define R_XMMD(r) (*(double *)&cpu->xmm_regs[(r)].ZMM_Q(0))
#define R_XMMS(r) (*(float *)&cpu->xmm_regs[(r)].ZMM_L(0))
...
typedef void* (*pFEpiV_t)(void*, int32_t, void*);
...
typedef void* (*pFEppp_t)(void*, void*, void*);
...
typedef void (*vFEpLipp_t)(void*, uintptr_t, int32_t, void*, void*);
...
typedef int32_t (*iFpuuuuuup_t)(void*, uint32_t, uint32_t, uint32_t, uint32_t, uint32_t, uint32_t, void*);
...
typedef uint32_t (*uFbupuuuuup_t)(void*, uint32_t, void*, uint32_t, uint32_t, uint32_t, uint32_t, uint32_t, void*);
typedef void* (*pFWWuCCCCuupup_t)(uint16_t, uint16_t, uint32_t, uint8_t, uint8_t, uint8_t, uint8_t, uint32_t, uint32_t, void*, uint32_t, void*);
typedef void* (*pFbWWuCpup_t)(void*, uint16_t, uint16_t, uint32_t, uint8_t, void*, uint32_t, void*);
typedef void* (*pFbuwwWWuu_t)(void*, uint32_t, int16_t, int16_t, uint16_t, uint16_t, uint32_t, uint32_t);
typedef uint64_t (*UFbuupwwC_t)(void*, uint32_t, uint32_t, void*, int16_t, int16_t, uint8_t);
typedef void* (*pFbuupppwwwwWWC_t)(void*, uint32_t, uint32_t, void*, void*, void*, int16_t, int16_t, int16_t, int16_t, uint16_t, uint16_t, uint8_t);
...
/* FreeType, Fontconfig, and Xft public ABI signatures. */
typedef uint8_t (*CFp_t)(void*);
typedef uint8_t (*CFpC_t)(void*, uint8_t);
typedef uintptr_t (*LFpLp_t)(void*, uintptr_t, void*);
typedef double (*dFd_t)(double);
typedef int32_t (*iFHH_t)(unsigned __int128, unsigned __int128);
...
typedef int32_t (*iFppHi_t)(void*, void*, unsigned __int128, int32_t);
typedef int32_t (*iFppLLppu_t)(void*, void*, uintptr_t, uintptr_t, void*, void*, uint32_t);
typedef uint8_t (*CFpup_t)(void*, uint32_t, void*);
typedef uint8_t (*CFpuppp_t)(void*, uint32_t, void*, void*, void*);
typedef uint8_t (*CFpuip_t)(void*, uint32_t, int32_t, void*);
...
typedef intptr_t (*lFpiupl_t)(void*, int32_t, uint32_t, void*, intptr_t);
...
typedef void (*vFH_t)(unsigned __int128);
...
/* Stateless GLib leaf ABI signatures. */
...
typedef int32_t (*iFpiuiiLLL_t)(void*, int32_t, uint32_t, int32_t, int32_t, uintptr_t, uintptr_t, uintptr_t);
...
void iFpiLL(uintptr_t fcn) { __CPU;  iFpiLL_t fn = (iFpiLL_t)fcn; R_RAX=(int32_t)fn((void*)R_RDI, (int32_t)R_RSI, (uintptr_t)R_RDX, (uintptr_t)R_RCX); DEBUG_LOG; (void)cpu; }
...
void pFEpiV(uintptr_t fcn) { __CPU; pFEpiV_t fn = (pFEpiV_t)fcn; R_RAX=(uintptr_t)fn((void*)R_RDI, (int32_t)R_RSI, (void*)(R_RSP + 8)); DEBUG_LOG; (void)cpu; }
...
void pFEppp(uintptr_t fcn) { __CPU; pFEppp_t fn = (pFEppp_t)fcn; R_RAX=(uintptr_t)fn((void*)R_RDI, (void*)R_RSI, (void*)R_RDX); DEBUG_LOG; (void)cpu; }
...
void vFEpLipp(uintptr_t fcn) { __CPU; vFEpLipp_t fn = (vFEpLipp_t)fcn; fn((void*)R_RDI, (uintptr_t)R_RSI, (int32_t)R_RDX, (void*)R_RCX, (void*)R_R8); DEBUG_LOG; (void)cpu; }
...
void iFpiuiiLLL(uintptr_t fcn) { __CPU; iFpiuiiLLL_t fn = (iFpiuiiLLL_t)fcn; R_RAX=(int32_t)fn((void*)R_RDI, (int32_t)R_RSI, (uint32_t)R_RDX, (int32_t)R_RCX, (int32_t)R_R8, (uintptr_t)R_R9, *(uintptr_t*)(R_RSP + 8), *(uintptr_t*)(R_RSP + 16)); DEBUG_LOG; (void)cpu; }
...
void CFU(uintptr_t fcn) { __CPU; CFU_t fn = (CFU_t)fcn; R_RAX=(uint8_t)fn((uint64_t)R_RDI); DEBUG_LOG; (void)cpu; }
void CFl(uintptr_t fcn) { __CPU; CFl_t fn = (CFl_t)fcn; R_RAX=(uint8_t)fn((intptr_t)R_RDI); DEBUG_LOG; (void)cpu; }
void LFppL(uintptr_t fcn) { __CPU; LFppL_t fn = (LFppL_t)fcn; R_RAX=(uintptr_t)fn((void*)R_RDI, (void*)R_RSI, (uintptr_t)R_RDX); DEBUG_LOG; (void)cpu; }
void LFppLp(uintptr_t fcn) { __CPU; LFppLp_t fn = (LFppLp_t)fcn; R_RAX=(uintptr_t)fn((void*)R_RDI, (void*)R_RSI, (uintptr_t)R_RDX, (void*)R_RCX); DEBUG_LOG; (void)cpu; }
void UFuiCiu(uintptr_t fcn) { __CPU; UFuiCiu_t fn = (UFuiCiu_t)fcn; R_RAX=fn((uint32_t)R_RDI, (int32_t)R_RSI, (uint8_t)R_RDX, (int32_t)R_RCX, (uint32_t)R_R8); DEBUG_LOG; (void)cpu; }
void iFpLLp(uintptr_t fcn) { __CPU; iFpLLp_t fn = (iFpLLp_t)fcn; R_RAX=(int32_t)fn((void*)R_RDI, (uintptr_t)R_RSI, (uintptr_t)R_RDX, (void*)R_RCX); DEBUG_LOG; (void)cpu; }
void iFpuuuuuup(uintptr_t fcn) { __CPU; iFpuuuuuup_t fn = (iFpuuuuuup_t)fcn; R_RAX=(int32_t)fn((void*)R_RDI, (uint32_t)R_RSI, (uint32_t)R_RDX, (uint32_t)R_RCX, (uint32_t)R_R8, (uint32_t)R_R9, *(uint32_t*)(R_RSP + 8), *(void**)(R_RSP + 16)); DEBUG_LOG; (void)cpu; }
void lFpuip(uintptr_t fcn) { __CPU; lFpuip_t fn = (lFpuip_t)fcn; R_RAX=(intptr_t)fn((void*)R_RDI, (uint32_t)R_RSI, (int32_t)R_RDX, (void*)R_RCX); DEBUG_LOG; (void)cpu; }
void lFui(uintptr_t fcn) { __CPU; lFui_t fn = (lFui_t)fcn; R_RAX=(intptr_t)fn((uint32_t)R_RDI, (int32_t)R_RSI); DEBUG_LOG; (void)cpu; }
void pFulu(uintptr_t fcn) { __CPU; pFulu_t fn = (pFulu_t)fcn; R_RAX=(uintptr_t)fn((uint32_t)R_RDI, (intptr_t)R_RSI, (uint32_t)R_RDX); DEBUG_LOG; (void)cpu; }
void vFLiii(uintptr_t fcn) { __CPU; vFLiii_t fn = (vFLiii_t)fcn; fn((uintptr_t)R_RDI, (int32_t)R_RSI, (int32_t)R_RDX, (int32_t)R_RCX); DEBUG_LOG; (void)cpu; }
void vFUu(uintptr_t fcn) { __CPU; vFUu_t fn = (vFUu_t)fcn; fn((uint64_t)R_RDI, (uint32_t)R_RSI); DEBUG_LOG; (void)cpu; }
void vFcc(uintptr_t fcn) { __CPU; vFcc_t fn = (vFcc_t)fcn; fn((int8_t)R_RDI, (int8_t)R_RSI); DEBUG_LOG; (void)cpu; }
void vFccc(uintptr_t fcn) { __CPU; vFccc_t fn = (vFccc_t)fcn; fn((int8_t)R_RDI, (int8_t)R_RSI, (int8_t)R_RDX); DEBUG_LOG; (void)cpu; }
void vFcccc(uintptr_t fcn) { __CPU; vFcccc_t fn = (vFcccc_t)fcn; fn((int8_t)R_RDI, (int8_t)R_RSI, (int8_t)R_RDX, (int8_t)R_RCX); DEBUG_LOG; (void)cpu; }
void vFlu(uintptr_t fcn) { __CPU; vFlu_t fn = (vFlu_t)fcn; fn((intptr_t)R_RDI, (uint32_t)R_RSI); DEBUG_LOG; (void)cpu; }
void vFluipp(uintptr_t fcn) { __CPU; vFluipp_t fn = (vFluipp_t)fcn; fn((intptr_t)R_RDI, (uint32_t)R_RSI, (int32_t)R_RDX, (void*)R_RCX, (void*)R_R8); DEBUG_LOG; (void)cpu; }
void vFpLip(uintptr_t fcn) { __CPU; vFpLip_t fn = (vFpLip_t)fcn; fn((void*)R_RDI, (uintptr_t)R_RSI, (int32_t)R_RDX, (void*)R_RCX); DEBUG_LOG; (void)cpu; }
void vFpLp(uintptr_t fcn) { __CPU; vFpLp_t fn = (vFpLp_t)fcn; fn((void*)R_RDI, (uintptr_t)R_RSI, (void*)R_RDX); DEBUG_LOG; (void)cpu; }
void vFuI(uintptr_t fcn) { __CPU; vFuI_t fn = (vFuI_t)fcn; fn((uint32_t)R_RDI, (int64_t)R_RSI); DEBUG_LOG; (void)cpu; }
void vFuII(uintptr_t fcn) { __CPU; vFuII_t fn = (vFuII_t)fcn; fn((uint32_t)R_RDI, (int64_t)R_RSI, (int64_t)R_RDX); DEBUG_LOG; (void)cpu; }
void vFuIII(uintptr_t fcn) { __CPU; vFuIII_t fn = (vFuIII_t)fcn; fn((uint32_t)R_RDI, (int64_t)R_RSI, (int64_t)R_RDX, (int64_t)R_RCX); DEBUG_LOG; (void)cpu; }
void vFuIIII(uintptr_t fcn) { __CPU; vFuIIII_t fn = (vFuIIII_t)fcn; fn((uint32_t)R_RDI, (int64_t)R_RSI, (int64_t)R_RDX, (int64_t)R_RCX, (int64_t)R_R8); DEBUG_LOG; (void)cpu; }
void vFuUU(uintptr_t fcn) { __CPU; vFuUU_t fn = (vFuUU_t)fcn; fn((uint32_t)R_RDI, (uint64_t)R_RSI, (uint64_t)R_RDX); DEBUG_LOG; (void)cpu; }
void vFuUUU(uintptr_t fcn) { __CPU; vFuUUU_t fn = (vFuUUU_t)fcn; fn((uint32_t)R_RDI, (uint64_t)R_RSI, (uint64_t)R_RDX, (uint64_t)R_RCX); DEBUG_LOG; (void)cpu; }
void vFuUUUU(uintptr_t fcn) { __CPU; vFuUUUU_t fn = (vFuUUUU_t)fcn; fn((uint32_t)R_RDI, (uint64_t)R_RSI, (uint64_t)R_RDX, (uint64_t)R_RCX, (uint64_t)R_R8); DEBUG_LOG; (void)cpu; }
void vFuUuuuuuuuuu(uintptr_t fcn) { __CPU; vFuUuuuuuuuuu_t fn = (vFuUuuuuuuuuu_t)fcn; fn((uint32_t)R_RDI, (uint64_t)R_RSI, (uint32_t)R_RDX, (uint32_t)R_RCX, (uint32_t)R_R8, (uint32_t)R_R9, *(uint32_t*)(R_RSP + 8), *(uint32_t*)(R_RSP + 16), *(uint32_t*)(R_RSP + 24), *(uint32_t*)(R_RSP + 32), *(uint32_t*)(R_RSP + 40)); DEBUG_LOG; (void)cpu; }
...
void vFuiupuffup(uintptr_t fcn) { __CPU; register float f0 __asm__("f16"); register float f1 __asm__("f17"); vFuiupuffup_t fn = (vFuiupuffup_t)fcn; fn((uint32_t)R_RDI, (int32_t)R_RSI, (uint32_t)R_RDX, (void*)R_RCX, (uint32_t)R_R8, f0, f1, (uint32_t)R_R9, *(void**)(R_RSP + 8)); DEBUG_LOG; (void)cpu; }
void vFuuUl(uintptr_t fcn) { __CPU; vFuuUl_t fn = (vFuuUl_t)fcn; fn((uint32_t)R_RDI, (uint32_t)R_RSI, (uint64_t)R_RDX, (intptr_t)R_RCX); DEBUG_LOG; (void)cpu; }
void vFuuiuil(uintptr_t fcn) { __CPU; vFuuiuil_t fn = (vFuuiuil_t)fcn; fn((uint32_t)R_RDI, (uint32_t)R_RSI, (int32_t)R_RDX, (uint32_t)R_RCX, (int32_t)R_R8, (intptr_t)R_R9); DEBUG_LOG; (void)cpu; }
void vFuuli(uintptr_t fcn) { __CPU; vFuuli_t fn = (vFuuli_t)fcn; fn((uint32_t)R_RDI, (uint32_t)R_RSI, (intptr_t)R_RDX, (int32_t)R_RCX); DEBUG_LOG; (void)cpu; }
void vFuulluup(uintptr_t fcn) { __CPU; vFuulluup_t fn = (vFuulluup_t)fcn; fn((uint32_t)R_RDI, (uint32_t)R_RSI, (intptr_t)R_RDX, (intptr_t)R_RCX, (uint32_t)R_R8, (uint32_t)R_R9, *(void**)(R_RSP + 8)); DEBUG_LOG; (void)cpu; }
void vFuupuuiuuf(uintptr_t fcn) { __CPU; register float f0 __asm__("f16"); vFuupuuiuuf_t fn = (vFuupuuiuuf_t)fcn; fn((uint32_t)R_RDI, (uint32_t)R_RSI, (void*)R_RDX, (uint32_t)R_RCX, (uint32_t)R_R8, (int32_t)R_R9, *(uint32_t*)(R_RSP + 8), *(uint32_t*)(R_RSP + 16), f0); DEBUG_LOG; (void)cpu; }
void vFuuuil(uintptr_t fcn) { __CPU; vFuuuil_t fn = (vFuuuil_t)fcn; fn((uint32_t)R_RDI, (uint32_t)R_RSI, (uint32_t)R_RDX, (int32_t)R_RCX, (intptr_t)R_R8); DEBUG_LOG; (void)cpu; }
void vFuuuiuCil(uintptr_t fcn) { __CPU; vFuuuiuCil_t fn = (vFuuuiuCil_t)fcn; fn((uint32_t)R_RDI, (uint32_t)R_RSI, (uint32_t)R_RDX, (int32_t)R_RCX, (uint32_t)R_R8, (uint8_t)R_R9, *(int32_t*)(R_RSP + 8), *(intptr_t*)(R_RSP + 16)); DEBUG_LOG; (void)cpu; }
void vFuuuiuil(uintptr_t fcn) { __CPU; vFuuuiuil_t fn = (vFuuuiuil_t)fcn; fn((uint32_t)R_RDI, (uint32_t)R_RSI, (uint32_t)R_RDX, (int32_t)R_RCX, (uint32_t)R_R8, (int32_t)R_R9, *(intptr_t*)(R_RSP + 8)); DEBUG_LOG; (void)cpu; }
void vFuuuli(uintptr_t fcn) { __CPU; vFuuuli_t fn = (vFuuuli_t)fcn; fn((uint32_t)R_RDI, (uint32_t)R_RSI, (uint32_t)R_RDX, (intptr_t)R_RCX, (int32_t)R_R8); DEBUG_LOG; (void)cpu; }
void vFuuuull(uintptr_t fcn) { __CPU; vFuuuull_t fn = (vFuuuull_t)fcn; fn((uint32_t)R_RDI, (uint32_t)R_RSI, (uint32_t)R_RDX, (uint32_t)R_RCX, (intptr_t)R_R8, (intptr_t)R_R9); DEBUG_LOG; (void)cpu; }
//endvulkan
//xcbV2
...
void uFbupuuuuup(uintptr_t fcn) { __CPU; uFbupuuuuup_t fn = (uFbupuuuuup_t)fcn; void *aligned_xcb = align_xcb_connection((void*)R_RDI); R_RAX=(uint32_t)fn(aligned_xcb, (uint32_t)R_RSI, (void*)R_RDX, (uint32_t)R_RCX, (uint32_t)R_R8, (uint32_t)R_R9, *(uint32_t*)(R_RSP + 8), *(uint32_t*)(R_RSP + 16), *(void**)(R_RSP + 24)); unalign_xcb_connection(aligned_xcb, (void*)R_RDI); DEBUG_LOG; (void)cpu; }
void pFWWuCCCCuupup(uintptr_t fcn) { __CPU; pFWWuCCCCuupup_t fn = (pFWWuCCCCuupup_t)fcn; R_RAX=(uintptr_t)fn((uint16_t)R_RDI, (uint16_t)R_RSI, (uint32_t)R_RDX, (uint8_t)R_RCX, (uint8_t)R_R8, (uint8_t)R_R9, *(uint8_t*)(R_RSP + 8), *(uint32_t*)(R_RSP + 16), *(uint32_t*)(R_RSP + 24), *(void**)(R_RSP + 32), *(uint32_t*)(R_RSP + 40), *(void**)(R_RSP + 48)); DEBUG_LOG; (void)cpu; }
void pFbWWuCpup(uintptr_t fcn) { __CPU; pFbWWuCpup_t fn = (pFbWWuCpup_t)fcn; void *aligned_xcb = align_xcb_connection((void*)R_RDI); R_RAX=(uintptr_t)fn(aligned_xcb, (uint16_t)R_RSI, (uint16_t)R_RDX, (uint32_t)R_RCX, (uint8_t)R_R8, (void*)R_R9, *(uint32_t*)(R_RSP + 8), *(void**)(R_RSP + 16)); unalign_xcb_connection(aligned_xcb, (void*)R_RDI); DEBUG_LOG; (void)cpu; }
void pFbuwwWWuu(uintptr_t fcn) { __CPU; pFbuwwWWuu_t fn = (pFbuwwWWuu_t)fcn; void *aligned_xcb = align_xcb_connection((void*)R_RDI); R_RAX=(uintptr_t)fn(aligned_xcb, (uint32_t)R_RSI, (int16_t)R_RDX, (int16_t)R_RCX, (uint16_t)R_R8, (uint16_t)R_R9, *(uint32_t*)(R_RSP + 8), *(uint32_t*)(R_RSP + 16)); unalign_xcb_connection(aligned_xcb, (void*)R_RDI); DEBUG_LOG; (void)cpu; }
void UFbuupwwC(uintptr_t fcn) { __CPU; UFbuupwwC_t fn = (UFbuupwwC_t)fcn; void *aligned_xcb = align_xcb_connection((void*)R_RDI); R_RAX=fn(aligned_xcb, (uint32_t)R_RSI, (uint32_t)R_RDX, (void*)R_RCX, (int16_t)R_R8, (int16_t)R_R9, *(uint8_t*)(R_RSP + 8)); unalign_xcb_connection(aligned_xcb, (void*)R_RDI); DEBUG_LOG; (void)cpu; }
void pFbuupppwwwwWWC(uintptr_t fcn) { __CPU; pFbuupppwwwwWWC_t fn = (pFbuupppwwwwWWC_t)fcn; void *aligned_xcb = align_xcb_connection((void*)R_RDI); R_RAX=(uintptr_t)fn(aligned_xcb, (uint32_t)R_RSI, (uint32_t)R_RDX, (void*)R_RCX, (void*)R_R8, (void*)R_R9, *(int16_t*)(R_RSP + 8), *(int16_t*)(R_RSP + 16), *(int16_t*)(R_RSP + 24), *(int16_t*)(R_RSP + 32), *(uint16_t*)(R_RSP + 40), *(uint16_t*)(R_RSP + 48), *(uint8_t*)(R_RSP + 56)); unalign_xcb_connection(aligned_xcb, (void*)R_RDI); DEBUG_LOG; (void)cpu; }
...
void HFH(uintptr_t fcn) { __CPU; HFH_t fn = (HFH_t)fcn; unsigned __int128 arg = (unsigned __int128)R_RDI | ((unsigned __int128)R_RSI << 64); unsigned __int128 ret = fn(arg); R_RAX=(uint64_t)ret; R_RDX=(uint64_t)(ret>>64); DEBUG_LOG; (void)cpu; }
...
void iFpdd(uintptr_t fcn) { __CPU; iFpdd_t fn = (iFpdd_t)fcn; R_RAX=(int32_t)fn((void*)R_RDI, R_XMMD(0), R_XMMD(1)); DEBUG_LOG; (void)cpu; }
void pFiii(uintptr_t fcn) { __CPU; pFiii_t fn = (pFiii_t)fcn; R_RAX=(uintptr_t)fn((int32_t)R_RDI, (int32_t)R_RSI, (int32_t)R_RDX); DEBUG_LOG; (void)cpu; }
void pFpdd(uintptr_t fcn) { __CPU; pFpdd_t fn = (pFpdd_t)fcn; R_RAX=(uintptr_t)fn((void*)R_RDI, R_XMMD(0), R_XMMD(1)); DEBUG_LOG; (void)cpu; }
void vFpuii(uintptr_t fcn) { __CPU; vFpuii_t fn = (vFpuii_t)fcn; fn((void*)R_RDI, (uint32_t)R_RSI, (int32_t)R_RDX, (int32_t)R_RCX); DEBUG_LOG; (void)cpu; }
void vFpudd(uintptr_t fcn) { __CPU; vFpudd_t fn = (vFpudd_t)fcn; fn((void*)R_RDI, (uint32_t)R_RSI, R_XMMD(0), R_XMMD(1)); DEBUG_LOG; (void)cpu; }
void vFpLii(uintptr_t fcn) { __CPU; vFpLii_t fn = (vFpLii_t)fcn; fn((void*)R_RDI, (uintptr_t)R_RSI, (int32_t)R_RDX, (int32_t)R_RCX); DEBUG_LOG; (void)cpu; }
void vFppid(uintptr_t fcn) { __CPU; vFppid_t fn = (vFppid_t)fcn; fn((void*)R_RDI, (void*)R_RSI, (int32_t)R_RDX, R_XMMD(0)); DEBUG_LOG; (void)cpu; }
void pFdddd(uintptr_t fcn) { __CPU; pFdddd_t fn = (pFdddd_t)fcn; R_RAX=(uintptr_t)fn(R_XMMD(0), R_XMMD(1), R_XMMD(2), R_XMMD(3)); DEBUG_LOG; (void)cpu; }
void pFpuii(uintptr_t fcn) { __CPU; pFpuii_t fn = (pFpuii_t)fcn; R_RAX=(uintptr_t)fn((void*)R_RDI, (uint32_t)R_RSI, (int32_t)R_RDX, (int32_t)R_RCX); DEBUG_LOG; (void)cpu; }
void pFpudd(uintptr_t fcn) { __CPU; pFpudd_t fn = (pFpudd_t)fcn; R_RAX=(uintptr_t)fn((void*)R_RDI, (uint32_t)R_RSI, R_XMMD(0), R_XMMD(1)); DEBUG_LOG; (void)cpu; }
void vFpuddd(uintptr_t fcn) { __CPU; vFpuddd_t fn = (vFpuddd_t)fcn; fn((void*)R_RDI, (uint32_t)R_RSI, R_XMMD(0), R_XMMD(1), R_XMMD(2)); DEBUG_LOG; (void)cpu; }
void vFpdddd(uintptr_t fcn) { __CPU; vFpdddd_t fn = (vFpdddd_t)fcn; fn((void*)R_RDI, R_XMMD(0), R_XMMD(1), R_XMMD(2), R_XMMD(3)); DEBUG_LOG; (void)cpu; }
void uFpuupp(uintptr_t fcn) { __CPU; uFpuupp_t fn = (uFpuupp_t)fcn; R_RAX=(uint32_t)fn((void*)R_RDI, (uint32_t)R_RSI, (uint32_t)R_RDX, (void*)R_RCX, (void*)R_R8); DEBUG_LOG; (void)cpu; }
void uFppppp(uintptr_t fcn) { __CPU; uFppppp_t fn = (uFppppp_t)fcn; R_RAX=(uint32_t)fn((void*)R_RDI, (void*)R_RSI, (void*)R_RDX, (void*)R_RCX, (void*)R_R8); DEBUG_LOG; (void)cpu; }
void pFpiiii(uintptr_t fcn) { __CPU; pFpiiii_t fn = (pFpiiii_t)fcn; R_RAX=(uintptr_t)fn((void*)R_RDI, (int32_t)R_RSI, (int32_t)R_RDX, (int32_t)R_RCX, (int32_t)R_R8); DEBUG_LOG; (void)cpu; }
void pFpdddd(uintptr_t fcn) { __CPU; pFpdddd_t fn = (pFpdddd_t)fcn; R_RAX=(uintptr_t)fn((void*)R_RDI, R_XMMD(0), R_XMMD(1), R_XMMD(2), R_XMMD(3)); DEBUG_LOG; (void)cpu; }
void pFpLpii(uintptr_t fcn) { __CPU; pFpLpii_t fn = (pFpLpii_t)fcn; R_RAX=(uintptr_t)fn((void*)R_RDI, (uintptr_t)R_RSI, (void*)R_RDX, (int32_t)R_RCX, (int32_t)R_R8); DEBUG_LOG; (void)cpu; }
void pFbupii(uintptr_t fcn) { __CPU; pFbupii_t fn = (pFbupii_t)fcn; void *aligned_xcb = align_xcb_connection((void*)R_RDI); R_RAX=(uintptr_t)fn(aligned_xcb, (uint32_t)R_RSI, (void*)R_RDX, (int32_t)R_RCX, (int32_t)R_R8); unalign_xcb_connection(aligned_xcb, (void*)R_RDI); DEBUG_LOG; (void)cpu; }
void pFbpuii(uintptr_t fcn) { __CPU; pFbpuii_t fn = (pFbpuii_t)fcn; void *aligned_xcb = align_xcb_connection((void*)R_RDI); R_RAX=(uintptr_t)fn(aligned_xcb, (void*)R_RSI, (uint32_t)R_RDX, (int32_t)R_RCX, (int32_t)R_R8); unalign_xcb_connection(aligned_xcb, (void*)R_RDI); DEBUG_LOG; (void)cpu; }
void vFpudddd(uintptr_t fcn) { __CPU; vFpudddd_t fn = (vFpudddd_t)fcn; fn((void*)R_RDI, (uint32_t)R_RSI, R_XMMD(0), R_XMMD(1), R_XMMD(2), R_XMMD(3)); DEBUG_LOG; (void)cpu; }
void vFpddddd(uintptr_t fcn) { __CPU; vFpddddd_t fn = (vFpddddd_t)fcn; fn((void*)R_RDI, R_XMMD(0), R_XMMD(1), R_XMMD(2), R_XMMD(3), R_XMMD(4)); DEBUG_LOG; (void)cpu; }
void uFpppLpp(uintptr_t fcn) { __CPU; uFpppLpp_t fn = (uFpppLpp_t)fcn; R_RAX=(uint32_t)fn((void*)R_RDI, (void*)R_RSI, (void*)R_RDX, (uintptr_t)R_RCX, (void*)R_R8, (void*)R_R9); DEBUG_LOG; (void)cpu; }
void pFpLppii(uintptr_t fcn) { __CPU; pFpLppii_t fn = (pFpLppii_t)fcn; R_RAX=(uintptr_t)fn((void*)R_RDI, (uintptr_t)R_RSI, (void*)R_RDX, (void*)R_RCX, (int32_t)R_R8, (int32_t)R_R9); DEBUG_LOG; (void)cpu; }
void pFbpupii(uintptr_t fcn) { __CPU; pFbpupii_t fn = (pFbpupii_t)fcn; void *aligned_xcb = align_xcb_connection((void*)R_RDI); R_RAX=(uintptr_t)fn(aligned_xcb, (void*)R_RSI, (uint32_t)R_RDX, (void*)R_RCX, (int32_t)R_R8, (int32_t)R_R9); unalign_xcb_connection(aligned_xcb, (void*)R_RDI); DEBUG_LOG; (void)cpu; }
void uFpippppp(uintptr_t fcn) { __CPU; uFpippppp_t fn = (uFpippppp_t)fcn; R_RAX=(uint32_t)fn((void*)R_RDI, (int32_t)R_RSI, (void*)R_RDX, (void*)R_RCX, (void*)R_R8, (void*)R_R9, *(void**)(R_RSP + 8)); DEBUG_LOG; (void)cpu; }
void uFpuupppp(uintptr_t fcn) { __CPU; uFpuupppp_t fn = (uFpuupppp_t)fcn; R_RAX=(uint32_t)fn((void*)R_RDI, (uint32_t)R_RSI, (uint32_t)R_RDX, (void*)R_RCX, (void*)R_R8, (void*)R_R9, *(void**)(R_RSP + 8)); DEBUG_LOG; (void)cpu; }
void uFppppppp(uintptr_t fcn) { __CPU; uFppppppp_t fn = (uFppppppp_t)fcn; R_RAX=(uint32_t)fn((void*)R_RDI, (void*)R_RSI, (void*)R_RDX, (void*)R_RCX, (void*)R_R8, (void*)R_R9, *(void**)(R_RSP + 8)); DEBUG_LOG; (void)cpu; }
void vFppipipiu(uintptr_t fcn) { __CPU; vFppipipiu_t fn = (vFppipipiu_t)fcn; fn((void*)R_RDI, (void*)R_RSI, (int32_t)R_RDX, (void*)R_RCX, (int32_t)R_R8, (void*)R_R9, *(int32_t*)(R_RSP + 8), *(uint32_t*)(R_RSP + 16)); DEBUG_LOG; (void)cpu; }
...
void CFp(uintptr_t fcn) { __CPU; CFp_t fn = (CFp_t)fcn; R_RAX=(uint8_t)fn((void*)R_RDI); DEBUG_LOG; (void)cpu; }
void CFpC(uintptr_t fcn) { __CPU; CFpC_t fn = (CFpC_t)fcn; R_RAX=(uint8_t)fn((void*)R_RDI, (uint8_t)R_RSI); DEBUG_LOG; (void)cpu; }
void LFpLp(uintptr_t fcn) { __CPU; LFpLp_t fn = (LFpLp_t)fcn; R_RAX=(uintptr_t)fn((void*)R_RDI, (uintptr_t)R_RSI, (void*)R_RDX); DEBUG_LOG; (void)cpu; }
void dFd(uintptr_t fcn) { __CPU; dFd_t fn = (dFd_t)fcn; R_XMMD(0)=fn(R_XMMD(0)); DEBUG_LOG; (void)cpu; }
void iFHH(uintptr_t fcn) { __CPU; iFHH_t fn = (iFHH_t)fcn; R_RAX=(int32_t)fn(((unsigned __int128)(uint64_t)R_RDI | ((unsigned __int128)(uint64_t)R_RSI << 64)), ((unsigned __int128)(uint64_t)R_RDX | ((unsigned __int128)(uint64_t)R_RCX << 64))); DEBUG_LOG; (void)cpu; }
void iFpLlpp(uintptr_t fcn) { __CPU; iFpLlpp_t fn = (iFpLlpp_t)fcn; R_RAX=(int32_t)fn((void*)R_RDI, (uintptr_t)R_RSI, (intptr_t)R_RDX, (void*)R_RCX, (void*)R_R8); DEBUG_LOG; (void)cpu; }
void iFpWp(uintptr_t fcn) { __CPU; iFpWp_t fn = (iFpWp_t)fcn; R_RAX=(int32_t)fn((void*)R_RDI, (uint16_t)R_RSI, (void*)R_RDX); DEBUG_LOG; (void)cpu; }
void iFplip(uintptr_t fcn) { __CPU; iFplip_t fn = (iFplip_t)fcn; R_RAX=(int32_t)fn((void*)R_RDI, (intptr_t)R_RSI, (int32_t)R_RDX, (void*)R_RCX); DEBUG_LOG; (void)cpu; }
void iFpll(uintptr_t fcn) { __CPU; iFpll_t fn = (iFpll_t)fcn; R_RAX=(int32_t)fn((void*)R_RDI, (intptr_t)R_RSI, (intptr_t)R_RDX); DEBUG_LOG; (void)cpu; }
void iFplluu(uintptr_t fcn) { __CPU; iFplluu_t fn = (iFplluu_t)fcn; R_RAX=(int32_t)fn((void*)R_RDI, (intptr_t)R_RSI, (intptr_t)R_RDX, (uint32_t)R_RCX, (uint32_t)R_R8); DEBUG_LOG; (void)cpu; }
void iFppC(uintptr_t fcn) { __CPU; iFppC_t fn = (iFppC_t)fcn; R_RAX=(int32_t)fn((void*)R_RDI, (void*)R_RSI, (uint8_t)R_RDX); DEBUG_LOG; (void)cpu; }
void iFppCC(uintptr_t fcn) { __CPU; iFppCC_t fn = (iFppCC_t)fcn; R_RAX=(int32_t)fn((void*)R_RDI, (void*)R_RSI, (uint8_t)R_RDX, (uint8_t)R_RCX); DEBUG_LOG; (void)cpu; }
void iFppHi(uintptr_t fcn) { __CPU; iFppHi_t fn = (iFppHi_t)fcn; R_RAX=(int32_t)fn((void*)R_RDI, (void*)R_RSI, ((unsigned __int128)(uint64_t)R_RDX | ((unsigned __int128)(uint64_t)R_RCX << 64)), (int32_t)R_R8); DEBUG_LOG; (void)cpu; }
void iFppLLppu(uintptr_t fcn) { __CPU; iFppLLppu_t fn = (iFppLLppu_t)fcn; R_RAX=(int32_t)fn((void*)R_RDI, (void*)R_RSI, (uintptr_t)R_RDX, (uintptr_t)R_RCX, (void*)R_R8, (void*)R_R9, (uint32_t)*(uint32_t*)(R_RSP + 8)); DEBUG_LOG; (void)cpu; }
void CFpup(uintptr_t fcn) { __CPU; CFpup_t fn = (CFpup_t)fcn; R_RAX=(uint8_t)fn((void*)R_RDI, (uint32_t)R_RSI, (void*)R_RDX); DEBUG_LOG; (void)cpu; }
void CFpuppp(uintptr_t fcn) { __CPU; CFpuppp_t fn = (CFpuppp_t)fcn; R_RAX=(uint8_t)fn((void*)R_RDI, (uint32_t)R_RSI, (void*)R_RDX, (void*)R_RCX, (void*)R_R8); DEBUG_LOG; (void)cpu; }
void CFpuip(uintptr_t fcn) { __CPU; CFpuip_t fn = (CFpuip_t)fcn; R_RAX=(uint8_t)fn((void*)R_RDI, (uint32_t)R_RSI, (int32_t)R_RDX, (void*)R_RCX); DEBUG_LOG; (void)cpu; }
void iFppLpp(uintptr_t fcn) { __CPU; iFppLpp_t fn = (iFppLpp_t)fcn; R_RAX=(int32_t)fn((void*)R_RDI, (void*)R_RSI, (uintptr_t)R_RDX, (void*)R_RCX, (void*)R_R8); DEBUG_LOG; (void)cpu; }
void iFppll(uintptr_t fcn) { __CPU; iFppll_t fn = (iFppll_t)fcn; R_RAX=(int32_t)fn((void*)R_RDI, (void*)R_RSI, (intptr_t)R_RDX, (intptr_t)R_RCX); DEBUG_LOG; (void)cpu; }
void iFppllp(uintptr_t fcn) { __CPU; iFppllp_t fn = (iFppllp_t)fcn; R_RAX=(int32_t)fn((void*)R_RDI, (void*)R_RSI, (intptr_t)R_RDX, (intptr_t)R_RCX, (void*)R_R8); DEBUG_LOG; (void)cpu; }
void iFppppL(uintptr_t fcn) { __CPU; iFppppL_t fn = (iFppppL_t)fcn; R_RAX=(int32_t)fn((void*)R_RDI, (void*)R_RSI, (void*)R_RDX, (void*)R_RCX, (uintptr_t)R_R8); DEBUG_LOG; (void)cpu; }
void iFpuip(uintptr_t fcn) { __CPU; iFpuip_t fn = (iFpuip_t)fcn; R_RAX=(int32_t)fn((void*)R_RDI, (uint32_t)R_RSI, (int32_t)R_RDX, (void*)R_RCX); DEBUG_LOG; (void)cpu; }
void iFpuipp(uintptr_t fcn) { __CPU; iFpuipp_t fn = (iFpuipp_t)fcn; R_RAX=(int32_t)fn((void*)R_RDI, (uint32_t)R_RSI, (int32_t)R_RDX, (void*)R_RCX, (void*)R_R8); DEBUG_LOG; (void)cpu; }
void iFpupC(uintptr_t fcn) { __CPU; iFpupC_t fn = (iFpupC_t)fcn; R_RAX=(int32_t)fn((void*)R_RDI, (uint32_t)R_RSI, (void*)R_RDX, (uint8_t)R_RCX); DEBUG_LOG; (void)cpu; }
void iFpupu(uintptr_t fcn) { __CPU; iFpupu_t fn = (iFpupu_t)fcn; R_RAX=(int32_t)fn((void*)R_RDI, (uint32_t)R_RSI, (void*)R_RDX, (uint32_t)R_RCX); DEBUG_LOG; (void)cpu; }
void iFpuuLppp(uintptr_t fcn) { __CPU; iFpuuLppp_t fn = (iFpuuLppp_t)fcn; R_RAX=(int32_t)fn((void*)R_RDI, (uint32_t)R_RSI, (uint32_t)R_RDX, (uintptr_t)R_RCX, (void*)R_R8, (void*)R_R9, (void*)*(void**)(R_RSP + 8)); DEBUG_LOG; (void)cpu; }
void iFpuuip(uintptr_t fcn) { __CPU; iFpuuip_t fn = (iFpuuip_t)fcn; R_RAX=(int32_t)fn((void*)R_RDI, (uint32_t)R_RSI, (uint32_t)R_RDX, (int32_t)R_RCX, (void*)R_R8); DEBUG_LOG; (void)cpu; }
...
void lFpiupl(uintptr_t fcn) { __CPU; lFpiupl_t fn = (lFpiupl_t)fcn; R_RAX=(intptr_t)fn((void*)R_RDI, (int32_t)R_RSI, (uint32_t)R_RDX, (void*)R_RCX, (intptr_t)R_R8); DEBUG_LOG; (void)cpu; }
void pFdd(uintptr_t fcn) { __CPU; pFdd_t fn = (pFdd_t)fcn; R_RAX=(uintptr_t)fn(R_XMMD(0), R_XMMD(1)); DEBUG_LOG; (void)cpu; }
void pFpLpL(uintptr_t fcn) { __CPU; pFpLpL_t fn = (pFpLpL_t)fcn; R_RAX=(uintptr_t)fn((void*)R_RDI, (uintptr_t)R_RSI, (void*)R_RDX, (uintptr_t)R_RCX); DEBUG_LOG; (void)cpu; }
void pFppipipp(uintptr_t fcn) { __CPU; pFppipipp_t fn = (pFppipipp_t)fcn; R_RAX=(uintptr_t)fn((void*)R_RDI, (void*)R_RSI, (int32_t)R_RDX, (void*)R_RCX, (int32_t)R_R8, (void*)R_R9, (void*)*(void**)(R_RSP + 8)); DEBUG_LOG; (void)cpu; }
void uFpL(uintptr_t fcn) { __CPU; uFpL_t fn = (uFpL_t)fcn; R_RAX=(uint32_t)fn((void*)R_RDI, (uintptr_t)R_RSI); DEBUG_LOG; (void)cpu; }
void uFpLL(uintptr_t fcn) { __CPU; uFpLL_t fn = (uFpLL_t)fcn; R_RAX=(uint32_t)fn((void*)R_RDI, (uintptr_t)R_RSI, (uintptr_t)R_RDX); DEBUG_LOG; (void)cpu; }
void uFppip(uintptr_t fcn) { __CPU; uFppip_t fn = (uFppip_t)fcn; R_RAX=(uint32_t)fn((void*)R_RDI, (void*)R_RSI, (int32_t)R_RDX, (void*)R_RCX); DEBUG_LOG; (void)cpu; }
void uFppiu(uintptr_t fcn) { __CPU; uFppiu_t fn = (uFppiu_t)fcn; R_RAX=(uint32_t)fn((void*)R_RDI, (void*)R_RSI, (int32_t)R_RDX, (uint32_t)R_RCX); DEBUG_LOG; (void)cpu; }
void uFppu(uintptr_t fcn) { __CPU; uFppu_t fn = (uFppu_t)fcn; R_RAX=(uint32_t)fn((void*)R_RDI, (void*)R_RSI, (uint32_t)R_RDX); DEBUG_LOG; (void)cpu; }
void uFpuppp(uintptr_t fcn) { __CPU; uFpuppp_t fn = (uFpuppp_t)fcn; R_RAX=(uint32_t)fn((void*)R_RDI, (uint32_t)R_RSI, (void*)R_RDX, (void*)R_RCX, (void*)R_R8); DEBUG_LOG; (void)cpu; }
void vFH(uintptr_t fcn) { __CPU; vFH_t fn = (vFH_t)fcn; fn(((unsigned __int128)(uint64_t)R_RDI | ((unsigned __int128)(uint64_t)R_RSI << 64))); DEBUG_LOG; (void)cpu; }
void vFpiLLiipi(uintptr_t fcn) { __CPU; vFpiLLiipi_t fn = (vFpiLLiipi_t)fcn; fn((void*)R_RDI, (int32_t)R_RSI, (uintptr_t)R_RDX, (uintptr_t)R_RCX, (int32_t)R_R8, (int32_t)R_R9, (void*)*(void**)(R_RSP + 8), (int32_t)*(int32_t*)(R_RSP + 16)); DEBUG_LOG; (void)cpu; }
void vFpiLpLiiiipi(uintptr_t fcn) { __CPU; vFpiLpLiiiipi_t fn = (vFpiLpLiiiipi_t)fcn; fn((void*)R_RDI, (int32_t)R_RSI, (uintptr_t)R_RDX, (void*)R_RCX, (uintptr_t)R_R8, (int32_t)R_R9, (int32_t)*(int32_t*)(R_RSP + 8), (int32_t)*(int32_t*)(R_RSP + 16), (int32_t)*(int32_t*)(R_RSP + 24), (void*)*(void**)(R_RSP + 32), (int32_t)*(int32_t*)(R_RSP + 40)); DEBUG_LOG; (void)cpu; }
void vFpiLpLiiiipui(uintptr_t fcn) { __CPU; vFpiLpLiiiipui_t fn = (vFpiLpLiiiipui_t)fcn; fn((void*)R_RDI, (int32_t)R_RSI, (uintptr_t)R_RDX, (void*)R_RCX, (uintptr_t)R_R8, (int32_t)R_R9, (int32_t)*(int32_t*)(R_RSP + 8), (int32_t)*(int32_t*)(R_RSP + 16), (int32_t)*(int32_t*)(R_RSP + 24), (void*)*(void**)(R_RSP + 32), (uint32_t)*(uint32_t*)(R_RSP + 40), (int32_t)*(int32_t*)(R_RSP + 48)); DEBUG_LOG; (void)cpu; }
void vFpiLpLiipi(uintptr_t fcn) { __CPU; vFpiLpLiipi_t fn = (vFpiLpLiipi_t)fcn; fn((void*)R_RDI, (int32_t)R_RSI, (uintptr_t)R_RDX, (void*)R_RCX, (uintptr_t)R_R8, (int32_t)R_R9, (int32_t)*(int32_t*)(R_RSP + 8), (void*)*(void**)(R_RSP + 16), (int32_t)*(int32_t*)(R_RSP + 24)); DEBUG_LOG; (void)cpu; }
void vFpll(uintptr_t fcn) { __CPU; vFpll_t fn = (vFpll_t)fcn; fn((void*)R_RDI, (intptr_t)R_RSI, (intptr_t)R_RDX); DEBUG_LOG; (void)cpu; }
void vFpluul(uintptr_t fcn) { __CPU; vFpluul_t fn = (vFpluul_t)fcn; fn((void*)R_RDI, (intptr_t)R_RSI, (uint32_t)R_RDX, (uint32_t)R_RCX, (intptr_t)R_R8); DEBUG_LOG; (void)cpu; }
void vFpppiipui(uintptr_t fcn) { __CPU; vFpppiipui_t fn = (vFpppiipui_t)fcn; fn((void*)R_RDI, (void*)R_RSI, (void*)R_RDX, (int32_t)R_RCX, (int32_t)R_R8, (void*)R_R9, (uint32_t)*(uint32_t*)(R_RSP + 8), (int32_t)*(int32_t*)(R_RSP + 16)); DEBUG_LOG; (void)cpu; }
void vFpppuip(uintptr_t fcn) { __CPU; vFpppuip_t fn = (vFpppuip_t)fcn; fn((void*)R_RDI, (void*)R_RSI, (void*)R_RDX, (uint32_t)R_RCX, (int32_t)R_R8, (void*)R_R9); DEBUG_LOG; (void)cpu; }
void LFppu(uintptr_t fcn) { __CPU; LFppu_t fn = (LFppu_t)fcn; R_RAX=(uintptr_t)fn((void*)R_RDI, (void*)R_RSI, (uint32_t)R_RDX); DEBUG_LOG; (void)cpu; }
void cFc(uintptr_t fcn) { __CPU; cFc_t fn = (cFc_t)fcn; R_RAX=(int8_t)fn((int8_t)R_RDI); DEBUG_LOG; (void)cpu; }
void iFLi(uintptr_t fcn) { __CPU; iFLi_t fn = (iFLi_t)fcn; R_RAX=(int32_t)fn((uintptr_t)R_RDI, (int32_t)R_RSI); DEBUG_LOG; (void)cpu; }
void iFc(uintptr_t fcn) { __CPU; iFc_t fn = (iFc_t)fcn; R_RAX=(int32_t)fn((int8_t)R_RDI); DEBUG_LOG; (void)cpu; }
void lFpl(uintptr_t fcn) { __CPU; lFpl_t fn = (lFpl_t)fcn; R_RAX=(intptr_t)fn((void*)R_RDI, (intptr_t)R_RSI); DEBUG_LOG; (void)cpu; }
void lFppu(uintptr_t fcn) { __CPU; lFppu_t fn = (lFppu_t)fcn; R_RAX=(intptr_t)fn((void*)R_RDI, (void*)R_RSI, (uint32_t)R_RDX); DEBUG_LOG; (void)cpu; }
void pFpid(uintptr_t fcn) { __CPU; pFpid_t fn = (pFpid_t)fcn; R_RAX=(uintptr_t)fn((void*)R_RDI, (int32_t)R_RSI, R_XMMD(0)); DEBUG_LOG; (void)cpu; }
void pFpipd(uintptr_t fcn) { __CPU; pFpipd_t fn = (pFpipd_t)fcn; R_RAX=(uintptr_t)fn((void*)R_RDI, (int32_t)R_RSI, (void*)R_RDX, R_XMMD(0)); DEBUG_LOG; (void)cpu; }
void pFpl(uintptr_t fcn) { __CPU; pFpl_t fn = (pFpl_t)fcn; R_RAX=(uintptr_t)fn((void*)R_RDI, (intptr_t)R_RSI); DEBUG_LOG; (void)cpu; }
void pFplu(uintptr_t fcn) { __CPU; pFplu_t fn = (pFplu_t)fcn; R_RAX=(uintptr_t)fn((void*)R_RDI, (intptr_t)R_RSI, (uint32_t)R_RDX); DEBUG_LOG; (void)cpu; }
void pFppc(uintptr_t fcn) { __CPU; pFppc_t fn = (pFppc_t)fcn; R_RAX=(uintptr_t)fn((void*)R_RDI, (void*)R_RSI, (int8_t)R_RDX); DEBUG_LOG; (void)cpu; }
void uFL(uintptr_t fcn) { __CPU; uFL_t fn = (uFL_t)fcn; R_RAX=(uint32_t)fn((uintptr_t)R_RDI); DEBUG_LOG; (void)cpu; }
void uFpl(uintptr_t fcn) { __CPU; uFpl_t fn = (uFpl_t)fcn; R_RAX=(uint32_t)fn((void*)R_RDI, (intptr_t)R_RSI); DEBUG_LOG; (void)cpu; }
//xcbV2end
#undef R_RAX
#undef R_RDI
#undef R_RSI
