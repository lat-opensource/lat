...
#undef CONFIG_LATX_LAZYTB
#define CONFIG_LATX_LAZYTB
#undef CONFIG_LATX_LAZYPC
#define CONFIG_LATX_LAZYPC
#undef CONFIG_LATX_LAZYEXIT
#define CONFIG_LATX_LAZYEXIT
