...
static inline int kzt_guest_tls_loader_event_observe(void)
{
    return 0;
}

static inline int kzt_guest_loader_operation_active(void)
{
    return 0;
}
...
static inline void kzt_guest_tls_fork_abort(void) {}
static inline int kzt_guest_tls_syscall_pause(CPUX86State *env)
{
    (void)env;
    return 0;
}
